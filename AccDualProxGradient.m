...
% function [x,k] = AccDualProxGradient(A,b,T,lambda,t)
...
clear all;
delete funconvergence_fdpgm.mat;
delete dfunconvergence_fdpgm.mat;
delete funconvergence_fdpgm_mean.mat;
delete dfunconvergence_fdpgm_mean.mat;
delete time_fdpgm.mat;
